...
import img_cover from '../../../assets/images/post/2022/2022-04-26_running-the-digital-overdose-conference-again/conference_cover_2022.png'
import img_streamasset from '../../../assets/images/post/2022/2022-04-26_running-the-digital-overdose-conference-again/stream-asset.png'
import img_streamasset2 from '../../../assets/images/post/2022/2022-04-26_running-the-digital-overdose-conference-again/stream-asset-2.png'
import img_track01gif from '../../../assets/images/post/2022/2022-04-26_running-the-digital-overdose-conference-again/TRACK01.gif'
import img_desksetup from '../../../assets/images/post/2022/2022-04-26_running-the-digital-overdose-conference-again/desk-setup.jpg'
import img_summaryday1 from '../../../assets/images/post/2022/2022-04-26_running-the-digital-overdose-conference-again/summary-day-1.png'
import img_summaryday2 from '../../../assets/images/post/2022/2022-04-26_running-the-digital-overdose-conference-again/summary-day-2.png'

Once more, we find ourselves at the end of a chapter of a long and ongoing adventure!

If you missed it, I am one of the managers for a community called Digital Overdose (which you can find at <ExternalLink url='https://digitaloverdose.tech/ctf/' text='this link' />).

I do a lot of things at D.O., from managing day-to-day events, maintaining the website, organizing and running their Capture The Flag events, and finally also running the Digital Overdose Conference (<em>dun-dun-dunnnnn"... pause for dramatic effect</em>).
...
More specifically, I'll be telling you how <strong>I</strong> do it, some of the things I do are just for flair, and honestly a bit over the top. <g-emoji class="g-emoji" alias="telescope" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f609.png">😉</g-emoji>
...
The Asset Preparation phase is where people like myself generate the stream assets, such as images, videos, layouts, etc. as well as source the relevant music assets. I'll be going a bit more into that in the [next section](#preparing-assets).
...
<ImageContainer image={img_cover} style="width: 50%; max-width: 400px; height: auto;" alt="The conference cover art" />

Then there's the stream assets, such as the various layouts used in OBS.

<ImageContainer image={img_streamasset} style="width: 70%; height: auto;" alt="Live shot of the stream assets in use, during a talk." />

<ImageContainer image={img_streamasset2} style="width: 70%; height: auto;" alt="Live shot of the stream assets in use, during a break." />

Also to note are musical assets, which we source beforehand and need to integrate into the stream assets in order to make the conference smooth, and to keep the attention of the attendees.

<ImageContainer image={img_track01gif} style="width: 50%; height: auto;" alt="10 second GIF of one of the audio assets." />

How did I make that, you ask? (Or if you didn't, that's a shame, you're still finding out <g-emoji class="g-emoji" alias="telescope" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f609.png">😉</g-emoji>)
...
The second part is transforming the <code>.nut</code> file to a <code>.mp4</code> file, as follows:
...
<TwitterEmbed text='Never spend 6 minutes doing something by hand when you can spend 6 hours failing to automate it' url='https://x.com/zhuowei/status/1254266079532154880' author='Zhuowei Zhang' profile='@zhuowei' date='Apr 26, 2020' />
...
<ImageContainer image={img_desksetup} style="width: 70%; height: auto;" alt="A picture of my desk during the conference." />

Let me explain: What you see there is the entire A/V setup for the conference.
...
<ImageContainer image={img_summaryday1} style="width: 70%; height: auto;" alt="Twitch stream statistics for the first day of the conference." />

<ImageContainer image={img_summaryday2} style="width: 70%; height: auto;" alt="Twitch stream statistics for the second day of the conference." />

What can we find out? Well, for starters - and unsurprisingly, Sunday is slightly less favoured by viewers.
