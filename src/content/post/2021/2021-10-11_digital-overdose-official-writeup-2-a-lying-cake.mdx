...
import description from '../../../assets/images/post/2021/2021-10-11_ctf/portal/description.png'
import hint from '../../../assets/images/post/2021/2021-10-11_ctf/portal/hint.png'
...
<div class='media-container'>
  <Image src={hint} style="width: 80%; height: auto" alt='ZWS in the code' />
</div>

<br/>
There exist a number of very interesting characters called "Zero-width space" characters, which can be found in unicode: <code>U+200B</code>, <code>U+200C</code>, <code>U+2060</code> and <code>U+FEFF</code>.
