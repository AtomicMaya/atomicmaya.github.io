...
It seems the universe had other plans, as 16 or so hours before the opening of the doors -- whilst I was still in Switzerland -- I get a message from my friend <TwitterLink url="https://twitter.com/craigmucka" text="Mucka" /> (a member of the organizing crew), because two of the speakers and one of the substitute speakers pulled out, so he decided to go with plan "Hey, let's ask Maya".
...
<div class='media-container'>
  <iframe loading="lazy" style="width: 70%; max-height: 500px; height: 400px;"
    src="https://www.youtube.com/embed/LCoNSj0q6zw?si=c_UkLUJFatSI1LNU" title="YouTube video player"
