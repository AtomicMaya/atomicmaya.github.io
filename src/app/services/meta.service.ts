...
export class MetaService {
  ...
  setTags(url: string,
    ...
    [
      ...
      { name: 'og:description', content: `${description ?? title + ': A post on \'AtomicMaya\'s Blog at the end of the universe, talking all things infosec, IoT, development and personal.'}` },
      { name: 'og:image', content: (imgUrl !== undefined) ? `${BASE_URL}${imgUrl}` : `${BASE_URL}/assets/images/cover.jpg` },
      { name: 'description', content: `${description ?? title + ': A post on \'AtomicMaya\'s Blog at the end of the universe, talking all things infosec, IoT, development and personal.'}` },
