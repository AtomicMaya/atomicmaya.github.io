...
export class MetaService {
  ...
  setTags(url: string,
    ...
    [
      ...
      { name: 'keywords', content: ['atomicmaya', 'osint', 'infosec', 'security', 'cybersec', 'cybersecurity', ...keywords.map(x => x.toLowerCase())].join(', ') },
      ...
      { name: 'twitter:site', content: '@AtomicMaya_' },
      { name: 'twitter:creator', content: `${authorSocial ?? '@AtomicMaya_' }` },
