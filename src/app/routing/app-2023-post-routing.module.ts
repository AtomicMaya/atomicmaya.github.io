...
export const subroutes2023: Routes = [
  ...
  },
  {
    ...
    data: {
      ...
      tags: [ TAG_INFOSEC, TAG_CYBERSEC, TAG_DEVELOPMENT, TAG_REVERSE_ENGINEERING, TAG_CYBERSEC ],
      date: [2023, 5, 11],
      readingTime: 15
    }
  },
  {
    ...
    data: {
      ...
      tags: [ TAG_INFOSEC, TAG_PROGRAMMING, TAG_DEVELOPMENT, TAG_REVERSE_ENGINEERING, TAG_CONFERENCE, TAG_TALKS, TAG_TRAVEL, TAG_CYBERSEC ],
      date: [2023, 7, 12],
      readingTime: 5
    }
  },
  ...
  },/*
  {
    ...
    data: {
      ...
      authors : [ authorList['AtomicMaya'] ],
      description: '',
      tags: [ TAG_PROGRAMMING, TAG_DEVELOPMENT ],
      date: [2023, 10, 20],
      readingTime: -1
    }
  }*/
