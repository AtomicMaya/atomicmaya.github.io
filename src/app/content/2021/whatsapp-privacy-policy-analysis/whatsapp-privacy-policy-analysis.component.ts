...
export class WhatsappPrivacyPolicyAnalysisComponent implements OnInit {
  post: Post;
  ...
  ngOnInit(): void {
    ...
    this.meta.setTags('/postx/2021/2021_01_08%2BWhatsApp-Privacy-Policy-Changes-Analysis', this.post.title,
